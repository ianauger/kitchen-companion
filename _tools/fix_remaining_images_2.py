#!/usr/bin/env python3
"""Fix missing images for recipes 11, 12, 14, and 18."""
import os
import sqlite3
import requests
import uuid
...
fixes = {
    11: 'https://images.unsplash.com/photo-1563245372-f21724e3856d?w=800&q=80',  # Kung pao chicken
    12: 'https://images.unsplash.com/photo-1473093295042-cdd812d0e601?w=800&q=80',  # Japanese curry
    14: 'https://images.unsplash.com/photo-1547592180-85f173990554?w=800&q=80',  # Thai curry
    18: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=800&q=80',  # Indian curry
}
...
for recipe_id, new_url in fixes.items():
    ...
    if relative_path:
        ...
        print(f'  Updated image_url only')
